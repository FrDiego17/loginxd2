                                ...
                                <div id="template" class="row panel-wrapper">
                                    <div class="col-12 panel-header basket-header">
                                        <div class="row">
                                            <div class="col-6 basket-title">
                                                <span class="description">Revise su</span><br><span class="emphasized">Resumen de compra</span>
                                            </div>
                                            <div class="col-6 order-number text-end">
                                                <span class="description">Numero de Orden</span><br><span class="emphasized">#00089</span>
                                            </div>
                                        </div>
                                        <div class="row column-titles padding-top-10">
                                            <div class="col-2 text-center"><span>Foto</span></div>
                                            <div class="col-5 text-center"><span>Nombre</span></div>
                                            <div class="col-2 text-center"><span>Cantidad</span></div>
                                            <div class="col-3 text-end"><span>Precio</span></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 panel-footer basket-footer">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-8 text-end description"><div class="dive">Propina</div></div>
                                            <div class="col-4 text-end"><span class="emphasized"></span>$0.50</div>
                                            <div class="col-8 text-end description"><div class="dive">Envío</div></div>
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                <div class="row panel-wrapper">
                                    <div class="col-12 panel-header creditcard-header">
                                        <div class="row">
                                            <div class="col-12 creditcard-title">
                                                <span class="description">Por favor ingrese su</span><br><span class="emphasized">Información de la Tarjeta</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 panel-footer creditcard-footer">
                                        <div class="row">
                                            <div class="col-12 text-end"><button class="btn btn-secondary cancel">Cancelar</button>&nbsp;<button class="btn btn-primary confirm">Confirmar y Pagar</button></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
