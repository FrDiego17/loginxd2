                ...
                <form action="/register" method="POST">
                    ...
                    <div class="mb-4">
                        <div class="input-group mb-3">
                            <span class="input-group-text">🔒</span>
                            <div class="form-floating">
                              <input name="password" type="password" class="form-control" id="passwordInput" placeholder="Contraseña" data-translate="contraseña">
                    ...
                    <div class="mb-4">
                        <div class="input-group mb-3">
                            <span class="input-group-text">🔒</span>
                            <div class="form-floating">
                              <input name="password_confirmation" type="password" class="form-control" id="passwordInput" placeholder="Contraseña" data-translate="confirmar-contraseña">
